...
const photos = [
  ...
  { src: "/gallery/q2.jpg", alt: "the mentor spending time with the senior football team" },
  ...
  { src: "/gallery/q1.jpg", alt: "having fun during community work with a football team" },
